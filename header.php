      ...
      <div class="header-container__info">
        ...
        <div class="icon-flex">
          <div class="header-container__info--icon">
            <a href="https://line.me/ti/p/6GV7QoHXlq" target="_blank" rel="noopener noreferrer"><img class="header-container__info--icon--img" src="<?php echo get_template_directory_uri(); ?>/assets/img/LINE.png" alt=""></a>
          </div>
          <div class="header-container__info--icon">
            <a href="http://royalsweet2021.livedoor.blog/" target="_blank" rel="noopener noreferrer"><img class="header-container__info--icon--img" src="<?php echo get_template_directory_uri(); ?>/assets/img/livedoor.png" alt=""></a>
          </div>
          <div class="header-container__info--icon">
            <a href="https://twitter.com/RoyalSweet13" target="_blank" rel="noopener noreferrer"><img class="header-container__info--icon--img" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-twitter.png" alt=""></a>
          </div>
        </div>
      </div><!-- .info -->
    ...
    <div class="hamburger-menu">
      ...
      <nav class="nav-container">
        <ul class="navlist gothic">
          ...
          <ul class="menu-tab">
            <li>
              <a href="https://line.me/ti/p/6GV7QoHXlq" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/LINE.png" alt="line"></a>
            </li>
            <li>
              <a href="http://royalsweet2021.livedoor.blog/" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/livedoor.png" alt="livedoor"></a>
            </li>
            <li>
              <a href="https://twitter.com/RoyalSweet13" target="_blank" rel="noopener noreferrer"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-twitter.png" alt="twitter"></a>
            </li>
          </ul>
        </ul>
      </nav>
