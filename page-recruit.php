...
<main>
  ...
  <section class="recruit common-bg">
    <div class="bg-white">
      <div class="gold-border"></div>

      <div class="top-visual">
        <div class="top-visual__bg">
          <img class="pc-topimg" src="<?php echo get_template_directory_uri(); ?>/img/recruit-top.png" alt="">
          <img class="sp-topimg" src="<?php echo get_template_directory_uri(); ?>/img/recruit-top02.jpg"
            alt="">
        </div>
        <div class="top-visual__text">
          <img src="<?php echo get_template_directory_uri(); ?>/img/recruit-toptext-royal.png"
            alt="圧倒的な高収入！安心して長く働ける！頑張る女性を応援します">
        </div>
        <div class="list-bg">
          <ul class="top-visual__list">
            <li class="top-visual__list--item"><img
                src="<?php echo get_template_directory_uri(); ?>/img/merit01.png" alt="未経験でも大歓迎！安心の研修制度"></li>
            <li class="top-visual__list--item"><img
                src="<?php echo get_template_directory_uri(); ?>/img/merit02.png" alt="ノルマ一切ナシ！完全自由出勤制度 "></li>
            <li class="top-visual__list--item"><img
                src="<?php echo get_template_directory_uri(); ?>/img/merit03.png" alt="圧倒的リピート会員数。しっかりと稼げます">
            </li>
          </ul>
        </div>
      </div><!-- .top-visual -->
      ...
      <section class="features">
        ...
        <div class="features__container features-margin01">
          <div class="features__container--img">
            <img src="<?php echo get_template_directory_uri(); ?>/img/work01.png" alt="70%が未経験からのスタート！">
          </div>
        ...
        <div class="features__container reverse">
          <div class="features__container--img">
            <img src="<?php echo get_template_directory_uri(); ?>/img/work02.png" alt="週1日からでも出勤できます！">
          </div>
          <div class="features__container--text">
            <h3 class="features__container--large">
        ...
        <div class="features__container features-margin02">
          <div class="features__container--img">
            <img src="<?php echo get_template_directory_uri(); ?>/img/work03.png" alt="プライバシー管理も徹底！">
          </div>
          <div class="features__container--text">
            <h3 class="features__container--large">
      ...
      <section class="salary">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/img/salary-text.png" alt="">
          ...
          <div class="model">
            <div class="modelbox">
              <div class="modelbox__img">
                <img src="<?php echo get_template_directory_uri(); ?>/img/simulation01.png" alt="">
            ...
            <div class="modelbox">
              <div class="modelbox__img">
                <img src="<?php echo get_template_directory_uri(); ?>/img/simulation02.png" alt="">
          ...
          <div class="worry-flex">
            ...
            <div class="worry__img">
              <img class="worry__img--mainimg"
                src="<?php echo get_template_directory_uri(); ?>/img/worry01.png" alt="">
              <div class="worry__img--deco01"><img
                  src="<?php echo get_template_directory_uri(); ?>/img/moyamoya.png" alt=""></div>
              <div class="worry__img--deco02"><img
                  src="<?php echo get_template_directory_uri(); ?>/img/konnnahazu.png" alt="こんなはずでは"></div>
            </div>
          </div>
        </div><!-- .worry-container -->
      </section><!-- ."worry -->
        ...
        <div class="safety__container">
          ...
          <div class="safety__imgbox">
            <div class="safety__imgbox--img"><img
                src="<?php echo get_template_directory_uri(); ?>/img/safety01.png" alt=""></div>
            <div class="safety__imgbox--img"><img
                src="<?php echo get_template_directory_uri(); ?>/img/safety02.png" alt=""></div>
          </div>
      ...
      <section class="recruit-contact">
        <div class="recruit-contact__container">
          ...
          <div class="recruit-contact__qr">
            <div class="qr-flex">
              <div class="qr-img"><img src="<?php echo get_template_directory_uri(); ?>/img/recruit-qr.png"
                  alt=""></div>
